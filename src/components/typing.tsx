      ...
      <div className="flex flex-col justify-around md:flex-row">
        <div className="col-span-8 place-self-center text-center sm:text-left justify-self-start">
          <h1 className="text-white mb-4 text-xl sm:text-2xl lg:text-4xl lg:leading-normal font-extrabold">
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-yellow-600">Olá, Como vai?</span>
            <br></br>
            <TypeAnimation sequence={["Sou o Pedro Siqueira", 1000, "Sou Dev Backend", 1000]} wrapper="span" speed={50} repeat={Infinity} />
          </h1>
            <p className="text-[#ADB7BE] text-xs sm:text-lg mb-6">Mas possuo experiência com desenvolvimento Fullstack e Mobile</p>
        </div>
